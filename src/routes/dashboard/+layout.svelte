        ...
        <aside class="w-60 bg-[#1c212c] h-full flex flex-col items-center pt-5 pb-2 space-y-7">
            ...
            <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
                ...
                <div class="w-full flex items-center gap-x-1.5 group select-none">
                    ...
                    <a class="bg-white/10 text-white group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="/dashboard">                    
                ...
                <div class="w-full flex items-center gap-x-1.5 group select-none">
                    ...
                    <a class="group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="/dashboard">
                        <svg class="h-5 w-5 group-hover:fill-red-600 dark:fill-gray-600  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
